...
import net.alaux.diosmio.gwt.client.ArtifactGwtService;
...
public class ArtifactGwtServiceImpl extends SpringGwtServlet implements
	ArtifactGwtService {

    public Log logger = LogFactory.getLog(ArtifactGwtServiceImpl.class);

    @Autowired
    ArtifactService artifactManager;
	...
	try {
	    artifactManager.update(createEntity(artifact));
	} catch (RemoteException e) {
	    e.printStackTrace();
	}
    }
