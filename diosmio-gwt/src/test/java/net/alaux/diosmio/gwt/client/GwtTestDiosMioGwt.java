 ...
 * details.
 */
public class GwtTestDiosMioGwt extends GWTTestCase {
	...
	return "net.alaux.diosmio.gwt.DiosMioGwtJUnit";
    }
    ...
    // target.setServiceEntryPoint(GWT.getModuleBaseURL() + "DiosMioGwt/greet");
    //
